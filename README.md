...
- 💼 **Professional Role:** Flutter Developer at **SparkTech Agency (Betopia Group)**, specializing in production-ready mobile and web applications.
- 🎓 **Education:** Diploma in Computer Science & Technology (Feni Polytechnic Institute) & B.Sc. in CSE (Northern University Bangladesh).
- 📱 **Core Expertise:** High-performance **Flutter & Dart**, **GetX State Management**, **Firebase Cloud**, **REST API**, and **Socket.io** real-time systems.
- 🚀 **Store Deployment:** Hands-on experience publishing and managing applications on both **Apple App Store** & **Google Play Store**.
- 🌐 **Interactive Portfolio:** Explore my live web portfolio at **[sakil-portfolio-836cf.web.app](https://sakil-portfolio-836cf.web.app/)**.
...
Here are some of the key production applications and projects from my portfolio across **iOS, Android, and Web**:

| 🚀 Project Name & Link | 🛠️ Tech Stack & Architecture | 📝 Overview & Features | 📌 Status |
| :--- | :--- | :--- | :---: |
| **[COP UK - PIWC Stoneyburn](https://github.com/sakilkhan649/handy.git)** | `Flutter` `REST API` `Firebase` `Push Notifications` | Comprehensive church & community management app with live sermon audio, event updates, and real-time alerts. | **Published**<br/>*(iOS & Android)* |
| **[Ekkali](https://github.com/sakilkhan649/moeb_26.git)** | `Flutter` `Socket.io` `Real-Time Chat` `Firebase` | Ride-sharing & driver hire platform with real-time location tracking, live messaging via Socket.io, and push notifications. | **Published**<br/>*(iOS & Android)* |
| **[DramaBox](https://github.com/sakilkhan649/uremz100.git)** | `Flutter` `Video Streaming` `In-App Purchase` `Reels UI` | Short-form vertical drama streaming series app featuring smooth playback, episode monetization (IAP), and reels-like UI. | **Published**<br/>*(iOS & Android)* |
| **[WeatherAppZero](https://github.com/sakilkhan649/weatherappzero)** | `Flutter` `REST API` `GetX` `Clean UI` | Beautiful real-time weather forecasting application with dynamic weather animations and REST API integration. | **Open Source** |
...
<p align="left">
  ...
  <img src="https://img.shields.io/badge/GetX-02569B?style=for-the-badge&logo=flutter&logoColor=white" alt="GetX State Management" />
  <img src="https://img.shields.io/badge/App_Store-0D1B2A?style=for-the-badge&logo=apple&logoColor=white" alt="App Store" />
...
I am always open to discussing **Flutter mobile/web app development**, new project collaborations, or creative app architectures.

<p align="center">
  <a href="https://sakil-portfolio-836cf.web.app/" target="_blank">
    <img src="https://img.shields.io/badge/🌐_Live_Portfolio-sakil--portfolio--836cf.web.app-00D2B4?style=for-the-badge&logo=google-chrome&logoColor=black" alt="Portfolio" />
  </a>
  <a href="https://linkedin.com/in/sakil-khan-b05475338" target="_blank">
    <img src="https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn" />
  </a>
  <a href="https://www.facebook.com/share/1bxbuaegr1/" target="_blank">
    <img src="https://img.shields.io/badge/Facebook-1877F2?style=for-the-badge&logo=facebook&logoColor=white" alt="Facebook" />
  </a>
  <a href="https://www.instagram.com/sakilcst/" target="_blank">
